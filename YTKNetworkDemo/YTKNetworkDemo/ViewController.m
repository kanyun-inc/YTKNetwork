...
- (void)sendBatchRequest {
    ...
    [batchRequest startWithCompletionBlockWithSuccess:^(YTKBatchRequest *batchRequest) {
        ...
        for (NSInteger i = 0; i < 3; i++)
        {
            ...
            NSString *filePath = [[self cachePath] stringByAppendingPathComponent:[self MD5:imgAPI.imageId]];
...
- (void)viewDidLoad {
    ...
    for (NSInteger i = 0; i < 3; i ++)
    {
        UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(5/2+125*i, 20, 120, 160)];
    ...
    btn.frame = CGRectMake(10, 20+160+20, 150, 20);
    [btn addTarget:self action:@selector(sendBatchRequest) forControlEvents:UIControlEventTouchUpInside];
    
    for (NSInteger i = 0; i < 3; i ++)
    {
        UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(5/2+125*i, 20+160+20+20+20, 120, 160)];
        imgView.backgroundColor = [UIColor grayColor];
        [self.view addSubview:imgView];
    ...
    btn2.frame = CGRectMake(10, 20+160+20+20+160+20+20, 150, 20);
